...
from dagster._core.definitions.events import AssetKey, AssetPartitionWipeRange, AssetWipeWorkItem
...
def do_asset_wipe_work(instance: DagsterInstance, work_item: AssetWipeWorkItem) -> None:
    for asset_key, partition_keys in work_item.asset_partition_ranges:
...
def get_asset_wipe_work(
    ...
    return AssetWipeWorkItem(
        assets=whole_assets_to_wipe, asset_partition_ranges=asset_partitions_to_wipe
    )
