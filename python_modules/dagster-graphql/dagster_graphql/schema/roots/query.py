...
from dagster._core.definitions.events import AssetKey, BackgroundAssetWipeStatus
...
class GrapheneQuery(graphene.ObjectType):
    ...
    @capture_error
    def resolve_backgroundAssetWipeStatus(
        self,
        graphene_info: ResolveInfo,
        workToken: str,
    ):
